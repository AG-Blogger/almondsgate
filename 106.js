            ...
            appendHTML: function() {
                if($(object).is('img')) {
                    ...
                    if(settings.animateIn) {    
                        var icon = '<span class="icon" style="position: absolute; center: -100%; top: 0; bottom: 0; height: 80%; width: 100%; background:url('+settings.icon+') center center no-repeat"></span>';
