            ...
            appendHTML: function() {
                if($(object).is('img')) {
                    ...
                    if(settings.animateIn) {    
                        var icon = '<span class="icon" style="position: absolute; center: -500%; top: 30; height: 100%; width: 100%; background:url('https://www.jqueryscript.net/demo/Responsive-jQuery-Lightbox-With-Amazing-CSS3-Effects-Fancy-Box-2/demo/4_s.jpg') center center no-repeat"></span>';
