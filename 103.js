            ...
            appendHTML: function() {
                if($(object).is('img')) {
                    ...
                    if(settings.animateIn) {    
                        var icon = '<span class="icon" style="position: absolute; center: -100%; top: 0; height: 80%; width: 100%; background:url('+settings.icon+') center center no-repeat"></span>';
                        ...
                        $(object).wrap('<div class="slickhoverWrapper" style="position: relative; max-width:50%; overflow:hidden; display:inline-block; background:url('+settings.icon+') center center no-repeat '+settings.color+';"></div>');        
                }
            },
            ...
            setEventHandlers: function() {
                ...
                $(object).on({
                    ...
                    mouseleave: function () {
                        ...
                        if (settings.animateIn) {
                            $(object).prev().stop().animate({ center: '100%' }, settings.speed, function(){
                                $(object).prev().css('center', '-100%');
                            });        
                        }
                    }
                });
